...
int main() {
    ...
    processFile("goodbranchdec.txt", "goodbranchdec_processed.txt", maxOutputSize, false);

    // Process badbranchdec.txt and add the result declaration
    processFile("badbranchdec.txt", "badbranchdec_processed.txt", maxOutputSize, true);
